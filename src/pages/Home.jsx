	...
	return (
		<>
			<div className="flex w-full h-full flex-column ">
				...
				<div about="NAVBAR" className="flex w-full justify-content-between flex-column align-items-center " style={{
					height:'65%',
				...
				<div className="mb-7"><Button label="Quem somos" severity="success" className="opacity-80"/></div>
				...
				<div about="CARDS" className="flex w-full justify-content-evenly">
					...
					<Card 
						Imagecard={Satelite}
						Message="Imagens de satélites(NDVI)"
						
						/>
					
					</div>
					
					<div about="Card Tempo">
						<Card 
							Imagecard={Tempo}
							Message="Previsão do Tempo"
						
						/>
					</div>
					
					
					<div about="Card Banco">

						<Card

							Imagecard={Registro}
							Message="Banco de Informações"
